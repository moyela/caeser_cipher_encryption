...
def caeser_cypher_decrypt
# this method brings all our previous functions together and uses them to translate our text to code
    decryptor = CaeserCypherKit.new(); lowercase_letters = decryptor.lowercase_letters; uppercase_letters = decryptor.uppercase_letters
    ...
    output = decryptor.cypher_decrypt(text, key)
