...
# this method brings all our previous functions together and uses them to translate our text to code, firsfor lowercase and then uppercase letters
    ...
    encryptor = CaeserCypherKit.new(); lowercase_letters = encryptor.lowercase_letters; uppercase_letters = encryptor.uppercase_letters
    ...
    output = encryptor.cypher_encrypt(text, key)
